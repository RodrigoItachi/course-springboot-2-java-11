package com.hawkandwolf.course.config;
...
import com.hawkandwolf.course.entities.Order;
import com.hawkandwolf.course.entities.User;
import com.hawkandwolf.course.entities.enums.OrderStatus;
import com.hawkandwolf.course.repositories.OrderRepository;
...
public class TestConfig implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		Order o1 = new Order(null, Instant.parse("2019-06-20T19:53:07Z"), OrderStatus.PIAD, u1);
